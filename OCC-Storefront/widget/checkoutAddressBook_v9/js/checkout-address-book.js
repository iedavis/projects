      ...
      onLoad: function(widget) {
        ...
        widget.displayInvalidBillingAddressText = function() {
        	return ((!widget.billingAddressEnabled() && !widget.displayUseAsBillAddress()
                    ...
                    && ko.unwrap(widget.order().shippingAddress().country) !== '')||(ko.isObservable(widget.order) && ko.isObservable(widget.order().billingAddress)
                    && widget.order().billingAddress() && ko.unwrap(widget.order().billingAddress().country) == ''));
        };
      },
