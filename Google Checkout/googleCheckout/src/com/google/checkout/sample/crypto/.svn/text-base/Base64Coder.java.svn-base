...
/**
 * The <b>Base64Coder</b> class provides methods for encoding strings and 
 * byte arrays into Base64 format. It also provides methods for decoding 
...
public class Base64Coder {
  ...
  */
  ...
  /**
  * The <b>encode (byte[] in)</b> method encodes a byte array into 
  * Base64 format. No blanks or line breaks are inserted.
