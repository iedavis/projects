...
public class AddMerchantOrderNumberElementImpl
    extends com.google.checkout.schema._2.impl.AddMerchantOrderNumberRequestImpl
    implements com.google.checkout.schema._2.AddMerchantOrderNumberElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.google.checkout.schema._2.impl.runtime.UnmarshallableObject, com.google.checkout.schema._2.impl.runtime.XMLSerializable, com.google.checkout.schema._2.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.google.checkout.schema._2.AddMerchantOrderNumberElement.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "add-merchant-order-number";
    }
    ...
    public com.google.checkout.schema._2.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.google.checkout.schema._2.impl.runtime.UnmarshallingContext context) {
        return new com.google.checkout.schema._2.impl.AddMerchantOrderNumberElementImpl.Unmarshaller(context);
    }

    public void serializeBody(com.google.checkout.schema._2.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://checkout.google.com/schema/2", "add-merchant-order-number");
...
+"\u0000~\u00004sq\u0000~\u0000.t\u0000\u0015merchant-order-numbert\u0000#http://checkout.google."
+"com/schema/2sq\u0000~\u0000#ppsq\u0000~\u0000\rppsr\u0000\"com.sun.msv.datatype.xsd.Tok"
+"enType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0011q\u0000~\u0000\u0018t\u0000\u0005tokenq\u0000~\u0000,\u0001q\u0000~\u0000\u001esq\u0000~\u0000\u001fq\u0000~\u0000=q\u0000"
+"~\u0000\u0018sq\u0000~\u0000.t\u0000\u0013google-order-numbert\u0000\u0000sq\u0000~\u0000!ppsq\u0000~\u0000#q\u0000~\u0000&pq\u0000~\u0000\'q"
+"\u0000~\u00000q\u0000~\u00004sq\u0000~\u0000.t\u0000\u0019add-merchant-order-numberq\u0000~\u00008sr\u0000\"com.sun."
...
+"q\u0000~\u0000\nq\u0000~\u0000\fq\u0000~\u0000\tq\u0000~\u0000\"q\u0000~\u0000Bx"));
        ...
        extends com.google.checkout.schema._2.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.google.checkout.schema._2.impl.AddMerchantOrderNumberElementImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("add-merchant-order-number" == ___local)&&("http://checkout.google.com/schema/2" == ___uri)) {
                ...
                switch (state) {
                    case  1 :
                        if (("google-order-number" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((com.google.checkout.schema._2.impl.AddMerchantOrderNumberRequestImpl)com.google.checkout.schema._2.impl.AddMerchantOrderNumberElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
                        break;
                    case  3 :
