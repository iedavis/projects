...
public class NotificationAcknowledgmentElementImpl
    extends com.google.checkout.schema._2.impl.NotificationAcknowledgmentImpl
    implements com.google.checkout.schema._2.NotificationAcknowledgmentElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.google.checkout.schema._2.impl.runtime.UnmarshallableObject, com.google.checkout.schema._2.impl.runtime.XMLSerializable, com.google.checkout.schema._2.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.google.checkout.schema._2.NotificationAcknowledgmentElement.class);
    }
    ...
    public com.google.checkout.schema._2.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.google.checkout.schema._2.impl.runtime.UnmarshallingContext context) {
        return new com.google.checkout.schema._2.impl.NotificationAcknowledgmentElementImpl.Unmarshaller(context);
    }

    public void serializeBody(com.google.checkout.schema._2.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://checkout.google.com/schema/2", "notification-acknowledgment");
...
+"ession\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0004sq\u0000~\u0000\f\u0001q\u0000~\u0000(sq\u0000~\u0000\"t\u0000\u001bnotification-ack"
+"nowledgmentt\u0000#http://checkout.google.com/schema/2sr\u0000\"com.sun"
...
+"pq\u0000~\u0000\tx"));
        ...
        extends com.google.checkout.schema._2.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.google.checkout.schema._2.impl.NotificationAcknowledgmentElementImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("notification-acknowledgment" == ___local)&&("http://checkout.google.com/schema/2" == ___uri)) {
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromEnterElement((((com.google.checkout.schema._2.impl.NotificationAcknowledgmentImpl)com.google.checkout.schema._2.impl.NotificationAcknowledgmentElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  3 :
            ...
            while (true) {
                switch (state) {
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.google.checkout.schema._2.impl.NotificationAcknowledgmentImpl)com.google.checkout.schema._2.impl.NotificationAcknowledgmentElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.google.checkout.schema._2.impl.NotificationAcknowledgmentImpl)com.google.checkout.schema._2.impl.NotificationAcknowledgmentElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.google.checkout.schema._2.impl.NotificationAcknowledgmentImpl)com.google.checkout.schema._2.impl.NotificationAcknowledgmentElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((com.google.checkout.schema._2.impl.NotificationAcknowledgmentImpl)com.google.checkout.schema._2.impl.NotificationAcknowledgmentElementImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
