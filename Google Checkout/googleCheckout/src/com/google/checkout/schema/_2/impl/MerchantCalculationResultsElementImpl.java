    ...
    implements com.google.checkout.schema._2.MerchantCalculationResultsElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.google.checkout.schema._2.impl.runtime.UnmarshallableObject, com.google.checkout.schema._2.impl.runtime.XMLSerializable, com.google.checkout.schema._2.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.google.checkout.schema._2.MerchantCalculationResultsElement.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "merchant-calculation-results";
    }
    ...
    public com.google.checkout.schema._2.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.google.checkout.schema._2.impl.runtime.UnmarshallingContext context) {
        return new com.google.checkout.schema._2.impl.MerchantCalculationResultsElementImpl.Unmarshaller(context);
    }

    public void serializeBody(com.google.checkout.schema._2.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://checkout.google.com/schema/2", "merchant-calculation-results");
...
+"~\u0000\u001at\u0000Dcom.google.checkout.schema._2.MerchantCalculationResul"
+"ts.ResultsTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-elements"
...
+"g/2001/XMLSchema-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0007resultst\u0000#http://chec"
+"kout.google.com/schema/2sq\u0000~\u0000\rppsq\u0000~\u0000\u0014q\u0000~\u0000\u0013pq\u0000~\u0000(q\u0000~\u00008q\u0000~\u0000\u001ds"
+"q\u0000~\u0000\u001et\u0000\u001cmerchant-calculation-resultsq\u0000~\u0000=sr\u0000\"com.sun.msv.gra"
...
+"~\u0000#q\u0000~\u0000>q\u0000~\u0000\u0011q\u0000~\u0000\tq\u0000~\u0000\u000ex"));
        ...
        extends com.google.checkout.schema._2.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.google.checkout.schema._2.impl.MerchantCalculationResultsElementImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("merchant-calculation-results" == ___local)&&("http://checkout.google.com/schema/2" == ___uri)) {
                    ...
                    case  1 :
                        if (("results" == ___local)&&("http://checkout.google.com/schema/2" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.google.checkout.schema._2.impl.MerchantCalculationResultsImpl)com.google.checkout.schema._2.impl.MerchantCalculationResultsElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                    case  3 :
