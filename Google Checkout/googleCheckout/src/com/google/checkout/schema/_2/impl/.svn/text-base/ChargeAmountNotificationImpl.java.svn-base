...
public class ChargeAmountNotificationImpl implements com.google.checkout.schema._2.ChargeAmountNotification, com.sun.xml.bind.JAXBObject, com.google.checkout.schema._2.impl.runtime.UnmarshallableObject, com.google.checkout.schema._2.impl.runtime.XMLSerializable, com.google.checkout.schema._2.impl.runtime.ValidatableObject
{

    protected com.google.checkout.schema._2.Money _LatestChargeAmount;
    protected java.lang.String _SerialNumber;
    protected java.lang.String _GoogleOrderNumber;
    protected com.google.checkout.schema._2.Money _TotalChargeAmount;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.google.checkout.schema._2.ChargeAmountNotification.class);
    }

    public com.google.checkout.schema._2.Money getLatestChargeAmount() {
        return _LatestChargeAmount;
    }

    public void setLatestChargeAmount(com.google.checkout.schema._2.Money value) {
        _LatestChargeAmount = value;
    }
    ...
    public com.google.checkout.schema._2.Money getTotalChargeAmount() {
        return _TotalChargeAmount;
    }

    public void setTotalChargeAmount(com.google.checkout.schema._2.Money value) {
        _TotalChargeAmount = value;
    }
    ...
    public com.google.checkout.schema._2.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.google.checkout.schema._2.impl.runtime.UnmarshallingContext context) {
        return new com.google.checkout.schema._2.impl.ChargeAmountNotificationImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.endElement();
        context.startElement("http://checkout.google.com/schema/2", "latest-charge-amount");
        context.childAsURIs(((com.sun.xml.bind.JAXBObject) _LatestChargeAmount), "LatestChargeAmount");
        context.endNamespaceDecls();
        context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _LatestChargeAmount), "LatestChargeAmount");
        context.endAttributes();
        context.childAsBody(((com.sun.xml.bind.JAXBObject) _LatestChargeAmount), "LatestChargeAmount");
        context.endElement();
        ...
        context.endElement();
        context.startElement("http://checkout.google.com/schema/2", "total-charge-amount");
        context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TotalChargeAmount), "TotalChargeAmount");
        context.endNamespaceDecls();
        context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TotalChargeAmount), "TotalChargeAmount");
        context.endAttributes();
        context.childAsBody(((com.sun.xml.bind.JAXBObject) _TotalChargeAmount), "TotalChargeAmount");
        context.endElement();
    }
...
+"st-charge-amountq\u0000~\u00009sq\u0000~\u0000\npp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000fppsr\u0000%com.sun.ms"
+"v.datatype.xsd.DateTimeType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000)com.sun.msv.dataty"
+"pe.xsd.DateTimeBaseType\u0014W\u001a@3\u00a5\u00b4\u00e5\u0002\u0000\u0000xq\u0000~\u0000\u0015q\u0000~\u0000\u001bt\u0000\bdateTimeq\u0000~\u0000"
+"\u001fq\u0000~\u0000!sq\u0000~\u0000\"q\u0000~\u0000Sq\u0000~\u0000\u001bsq\u0000~\u0000$ppsq\u0000~\u0000&q\u0000~\u0000)pq\u0000~\u0000*q\u0000~\u00001q\u0000~\u00005sq\u0000"
+"~\u0000/t\u0000\ttimestampq\u0000~\u00009sq\u0000~\u0000\npp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\npp\u0000sq\u0000~\u0000$ppsq\u0000~\u0000>"
+"q\u0000~\u0000)psq\u0000~\u0000&q\u0000~\u0000)pq\u0000~\u0000Cq\u0000~\u0000Eq\u0000~\u00005sq\u0000~\u0000/q\u0000~\u0000Gq\u0000~\u0000Hsq\u0000~\u0000$ppsq\u0000"
+"~\u0000&q\u0000~\u0000)pq\u0000~\u0000*q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\u0013total-charge-amountq\u0000~\u00009sq\u0000"
+"~\u0000&ppsq\u0000~\u0000\u000fppsq\u0000~\u0000\u0014q\u0000~\u0000\u001bt\u0000\u0006stringsr\u00005com.sun.msv.datatype.xs"
+"d.WhiteSpaceProcessor$Preserve\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u001e\u0001q\u0000~\u0000!sq\u0000~\u0000\"q"
+"\u0000~\u0000gq\u0000~\u0000\u001bsq\u0000~\u0000/t\u0000\rserial-numbert\u0000\u0000sr\u0000\"com.sun.msv.grammar.Ex"
...
+"\u0000$Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0010\u0001pq\u0000~\u0000;q\u0000~\u0000Zq\u0000~\u0000"
+"\u0007q\u0000~\u0000\u0005q\u0000~\u0000Nq\u0000~\u0000%q\u0000~\u0000Iq\u0000~\u0000Uq\u0000~\u0000`q\u0000~\u0000\bq\u0000~\u0000@q\u0000~\u0000]q\u0000~\u0000\u000eq\u0000~\u0000\tq\u0000~\u0000"
+"=q\u0000~\u0000\\x"));
        }
        ...
        extends com.google.checkout.schema._2.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.google.checkout.schema._2.impl.ChargeAmountNotificationImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        if (("total-charge-amount" == ___local)&&("http://checkout.google.com/schema/2" == ___uri)) {
                        ...
                        if (("latest-charge-amount" == ___local)&&("http://checkout.google.com/schema/2" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 6;
                            return ;
                        }
                ...
                switch (state) {
                    ...
                    case  6 :
                        if (("currency" == ___local)&&("" == ___uri)) {
                            _LatestChargeAmount = ((com.google.checkout.schema._2.impl.MoneyImpl) spawnChildFromEnterAttribute((com.google.checkout.schema._2.impl.MoneyImpl.class), 7, ___uri, ___local, ___qname));
                            return ;
                        }
                        break;
                    case  4 :
                        if (("currency" == ___local)&&("" == ___uri)) {
                            _TotalChargeAmount = ((com.google.checkout.schema._2.impl.MoneyImpl) spawnChildFromEnterAttribute((com.google.checkout.schema._2.impl.MoneyImpl.class), 5, ___uri, ___local, ___qname));
                            return ;
                        }
                        break;
                    case  0 :
