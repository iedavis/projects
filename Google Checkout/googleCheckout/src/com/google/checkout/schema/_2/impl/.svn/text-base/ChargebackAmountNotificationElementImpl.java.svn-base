...
public class ChargebackAmountNotificationElementImpl
    extends com.google.checkout.schema._2.impl.ChargebackAmountNotificationImpl
    implements com.google.checkout.schema._2.ChargebackAmountNotificationElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.google.checkout.schema._2.impl.runtime.UnmarshallableObject, com.google.checkout.schema._2.impl.runtime.XMLSerializable, com.google.checkout.schema._2.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.google.checkout.schema._2.ChargebackAmountNotificationElement.class);
    }
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "chargeback-amount-notification";
    }
    ...
    public com.google.checkout.schema._2.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.google.checkout.schema._2.impl.runtime.UnmarshallingContext context) {
        return new com.google.checkout.schema._2.impl.ChargebackAmountNotificationElementImpl.Unmarshaller(context);
    }

    public void serializeBody(com.google.checkout.schema._2.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://checkout.google.com/schema/2", "chargeback-amount-notification");
...
+"\u0000~\u00007sq\u0000~\u00001t\u0000\u0018latest-chargeback-amountq\u0000~\u0000;sq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007pps"
+"q\u0000~\u0000\u0011ppsr\u0000%com.sun.msv.datatype.xsd.DateTimeType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000x"
+"r\u0000)com.sun.msv.datatype.xsd.DateTimeBaseType\u0014W\u001a@3\u00a5\u00b4\u00e5\u0002\u0000\u0000xq\u0000~\u0000"
+"\u0017q\u0000~\u0000\u001dt\u0000\bdateTimeq\u0000~\u0000!q\u0000~\u0000#sq\u0000~\u0000$q\u0000~\u0000Uq\u0000~\u0000\u001dsq\u0000~\u0000&ppsq\u0000~\u0000(q\u0000~"
+"\u0000+pq\u0000~\u0000,q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\ttimestampq\u0000~\u0000;sq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007ppsq"
+"\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000&ppsq\u0000~\u0000@q\u0000~\u0000+psq\u0000~\u0000(q\u0000~\u0000+pq\u0000~\u0000Eq\u0000~\u0000Gq\u0000~\u00007sq\u0000~\u00001"
+"q\u0000~\u0000Iq\u0000~\u0000Jsq\u0000~\u0000&ppsq\u0000~\u0000(q\u0000~\u0000+pq\u0000~\u0000,q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\u0017total-"
+"chargeback-amountq\u0000~\u0000;sq\u0000~\u0000(ppsq\u0000~\u0000\u0011ppsq\u0000~\u0000\u0016q\u0000~\u0000\u001dt\u0000\u0006stringsr"
+"\u00005com.sun.msv.datatype.xsd.WhiteSpaceProcessor$Preserve\u0000\u0000\u0000\u0000\u0000"
+"\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000 \u0001q\u0000~\u0000#sq\u0000~\u0000$q\u0000~\u0000iq\u0000~\u0000\u001dsq\u0000~\u00001t\u0000\rserial-numbert\u0000\u0000s"
+"q\u0000~\u0000&ppsq\u0000~\u0000(q\u0000~\u0000+pq\u0000~\u0000,q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\u001echargeback-amount"
...
+"rammar/ExpressionPool;xp\u0000\u0000\u0000\u0012\u0001pq\u0000~\u0000=q\u0000~\u0000\\q\u0000~\u0000\fq\u0000~\u0000\tq\u0000~\u0000Pq\u0000~\u0000\'"
+"q\u0000~\u0000Kq\u0000~\u0000Wq\u0000~\u0000bq\u0000~\u0000pq\u0000~\u0000\rq\u0000~\u0000Bq\u0000~\u0000_q\u0000~\u0000\nq\u0000~\u0000\u0010q\u0000~\u0000\u000eq\u0000~\u0000?q\u0000~\u0000^"
+"x"));
        }
        ...
        extends com.google.checkout.schema._2.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.google.checkout.schema._2.impl.ChargebackAmountNotificationElementImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        ...
                        break;
                    case  0 :
                        if (("chargeback-amount-notification" == ___local)&&("http://checkout.google.com/schema/2" == ___uri)) {
                ...
                switch (state) {
                    case  1 :
                        if (("serial-number" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((com.google.checkout.schema._2.impl.ChargebackAmountNotificationImpl)com.google.checkout.schema._2.impl.ChargebackAmountNotificationElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
                        break;
                    case  3 :
