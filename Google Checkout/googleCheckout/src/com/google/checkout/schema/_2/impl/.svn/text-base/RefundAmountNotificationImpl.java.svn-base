...
public class RefundAmountNotificationImpl implements com.google.checkout.schema._2.RefundAmountNotification, com.sun.xml.bind.JAXBObject, com.google.checkout.schema._2.impl.runtime.UnmarshallableObject, com.google.checkout.schema._2.impl.runtime.XMLSerializable, com.google.checkout.schema._2.impl.runtime.ValidatableObject
{

    protected java.lang.String _SerialNumber;
    protected com.google.checkout.schema._2.Money _LatestRefundAmount;
    protected com.google.checkout.schema._2.Money _TotalRefundAmount;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.google.checkout.schema._2.RefundAmountNotification.class);
    }
    ...
    public com.google.checkout.schema._2.Money getLatestRefundAmount() {
        return _LatestRefundAmount;
    }

    public void setLatestRefundAmount(com.google.checkout.schema._2.Money value) {
        _LatestRefundAmount = value;
    }

    public com.google.checkout.schema._2.Money getTotalRefundAmount() {
        return _TotalRefundAmount;
    }

    public void setTotalRefundAmount(com.google.checkout.schema._2.Money value) {
    ...
    public com.google.checkout.schema._2.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.google.checkout.schema._2.impl.runtime.UnmarshallingContext context) {
        return new com.google.checkout.schema._2.impl.RefundAmountNotificationImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.endElement();
        context.startElement("http://checkout.google.com/schema/2", "latest-refund-amount");
        context.childAsURIs(((com.sun.xml.bind.JAXBObject) _LatestRefundAmount), "LatestRefundAmount");
        context.endNamespaceDecls();
        context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _LatestRefundAmount), "LatestRefundAmount");
        context.endAttributes();
        context.childAsBody(((com.sun.xml.bind.JAXBObject) _LatestRefundAmount), "LatestRefundAmount");
        context.endElement();
        ...
        context.endElement();
        context.startElement("http://checkout.google.com/schema/2", "total-refund-amount");
        context.childAsURIs(((com.sun.xml.bind.JAXBObject) _TotalRefundAmount), "TotalRefundAmount");
        context.endNamespaceDecls();
        context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _TotalRefundAmount), "TotalRefundAmount");
        context.endAttributes();
        context.childAsBody(((com.sun.xml.bind.JAXBObject) _TotalRefundAmount), "TotalRefundAmount");
        context.endElement();
    }
...
+"~\u0000&q\u0000~\u0000)pq\u0000~\u0000*q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\u0013total-refund-amountq\u0000~\u00009sq\u0000"
...
+"=q\u0000~\u0000\\x"));
        ...
        extends com.google.checkout.schema._2.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.google.checkout.schema._2.impl.RefundAmountNotificationImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  3 :
                        if (("total-refund-amount" == ___local)&&("http://checkout.google.com/schema/2" == ___uri)) {
                        ...
                        if (("latest-refund-amount" == ___local)&&("http://checkout.google.com/schema/2" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 10;
                            return ;
                        }
                ...
                switch (state) {
                    case  4 :
                        if (("currency" == ___local)&&("" == ___uri)) {
                            _TotalRefundAmount = ((com.google.checkout.schema._2.impl.MoneyImpl) spawnChildFromEnterAttribute((com.google.checkout.schema._2.impl.MoneyImpl.class), 5, ___uri, ___local, ___qname));
                            return ;
                        }
                        break;
                    case  10 :
                        if (("currency" == ___local)&&("" == ___uri)) {
                            _LatestRefundAmount = ((com.google.checkout.schema._2.impl.MoneyImpl) spawnChildFromEnterAttribute((com.google.checkout.schema._2.impl.MoneyImpl.class), 11, ___uri, ___local, ___qname));
                            return ;
                        }
                        break;
                    case  0 :
