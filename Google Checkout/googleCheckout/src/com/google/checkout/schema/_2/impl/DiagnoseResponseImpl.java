...
public class DiagnoseResponseImpl implements com.google.checkout.schema._2.DiagnoseResponse, com.sun.xml.bind.JAXBObject, com.google.checkout.schema._2.impl.runtime.UnmarshallableObject, com.google.checkout.schema._2.impl.runtime.XMLSerializable, com.google.checkout.schema._2.impl.runtime.ValidatableObject
{
    ...
    public com.google.checkout.schema._2.DiagnoseResponse.WarningsType getWarnings() {
        return _Warnings;
    }

    public void setWarnings(com.google.checkout.schema._2.DiagnoseResponse.WarningsType value) {
        _Warnings = value;
    }

    public com.google.checkout.schema._2.AnyType getInputXml() {
        return _InputXml;
    }

    public void setInputXml(com.google.checkout.schema._2.AnyType value) {
        _InputXml = value;
    }
    ...
    public com.google.checkout.schema._2.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.google.checkout.schema._2.impl.runtime.UnmarshallingContext context) {
        return new com.google.checkout.schema._2.impl.DiagnoseResponseImpl.Unmarshaller(context);
    }

    public void serializeBody(com.google.checkout.schema._2.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://checkout.google.com/schema/2", "input-xml");
        context.childAsURIs(((com.sun.xml.bind.JAXBObject) _InputXml), "InputXml");
        context.endNamespaceDecls();
        context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _InputXml), "InputXml");
        context.endAttributes();
        context.childAsBody(((com.sun.xml.bind.JAXBObject) _InputXml), "InputXml");
        context.endElement();
        if (_Warnings!= null) {
            context.startElement("http://checkout.google.com/schema/2", "warnings");
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Warnings), "Warnings");
            context.endNamespaceDecls();
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Warnings), "Warnings");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Warnings), "Warnings");
            context.endElement();
        }
    }
...
+"gle.checkout.schema._2.AnyTypet\u0000+http://java.sun.com/jaxb/xj"
...
+"http://www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\tinput"
+"-xmlt\u0000#http://checkout.google.com/schema/2sq\u0000~\u0000\u000eppsq\u0000~\u0000\bq\u0000~\u0000"
+"\u0014p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0010q\u0000~\u0000\u0014psq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000\u0018q\u0000~"
+"\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000;com.google.checkout.schema._2.DiagnoseRespon"
+"se.WarningsTypeq\u0000~\u0000#sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00009q\u0000~\u0000\u001esq\u0000~\u0000"
+"\u001ft\u0000\bwarningsq\u0000~\u0000>q\u0000~\u0000\u001esq\u0000~\u0000\u0015ppsq\u0000~\u0000&ppsr\u0000#com.sun.msv.dataty"
+"pe.xsd.StringType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001Z\u0000\risAlwaysValidxq\u0000~\u0000+q\u0000~\u00000t\u0000\u0006st"
+"ringsr\u00005com.sun.msv.datatype.xsd.WhiteSpaceProcessor$Preserv"
+"e\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u00003\u0001q\u0000~\u00006sq\u0000~\u00007q\u0000~\u0000Pq\u0000~\u00000sq\u0000~\u0000\u001ft\u0000\rserial-numb"
+"ert\u0000\u0000sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\bexp"
...
+"sionPool;xp\u0000\u0000\u0000\u000b\u0001pq\u0000~\u0000\fq\u0000~\u0000Aq\u0000~\u0000\u0007q\u0000~\u0000$q\u0000~\u0000Hq\u0000~\u0000\u0005q\u0000~\u0000\u0012q\u0000~\u0000Dq\u0000~"
+"\u0000\u000fq\u0000~\u0000Cq\u0000~\u0000?x"));
        }
        ...
        extends com.google.checkout.schema._2.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.google.checkout.schema._2.impl.DiagnoseResponseImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        if (("warnings" == ___local)&&("http://checkout.google.com/schema/2" == ___uri)) {
                            context.pushAttributes(__atts, false);
                            state = 4;
                            return ;
                        }
                        if (("input-xml" == ___local)&&("http://checkout.google.com/schema/2" == ___uri)) {
                            context.pushAttributes(__atts, false);
                            state = 6;
                            return ;
                        }
                    ...
                    case  4 :
                        if (("string" == ___local)&&("http://checkout.google.com/schema/2" == ___uri)) {
                            _Warnings = ((com.google.checkout.schema._2.impl.DiagnoseResponseImpl.WarningsTypeImpl) spawnChildFromEnterElement((com.google.checkout.schema._2.impl.DiagnoseResponseImpl.WarningsTypeImpl.class), 5, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        _Warnings = ((com.google.checkout.schema._2.impl.DiagnoseResponseImpl.WarningsTypeImpl) spawnChildFromEnterElement((com.google.checkout.schema._2.impl.DiagnoseResponseImpl.WarningsTypeImpl.class), 5, ___uri, ___local, ___qname, __atts));
                        return ;
                    case  6 :
                        if (true) {
                            _InputXml = ((com.google.checkout.schema._2.impl.AnyTypeImpl) spawnChildFromEnterElement((com.google.checkout.schema._2.impl.AnyTypeImpl.class), 7, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  4 :
                        _Warnings = ((com.google.checkout.schema._2.impl.DiagnoseResponseImpl.WarningsTypeImpl) spawnChildFromLeaveElement((com.google.checkout.schema._2.impl.DiagnoseResponseImpl.WarningsTypeImpl.class), 5, ___uri, ___local, ___qname));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  4 :
                        _Warnings = ((com.google.checkout.schema._2.impl.DiagnoseResponseImpl.WarningsTypeImpl) spawnChildFromEnterAttribute((com.google.checkout.schema._2.impl.DiagnoseResponseImpl.WarningsTypeImpl.class), 5, ___uri, ___local, ___qname));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  4 :
                        _Warnings = ((com.google.checkout.schema._2.impl.DiagnoseResponseImpl.WarningsTypeImpl) spawnChildFromLeaveAttribute((com.google.checkout.schema._2.impl.DiagnoseResponseImpl.WarningsTypeImpl.class), 5, ___uri, ___local, ___qname));
                        return ;
                    case  2 :
                        if (("serial-number" == ___local)&&("" == ___uri)) {
                            state = 3;
                ...
                try {
                    switch (state) {
                        ...
                        case  0 :
                            ...
                            break;
                        case  4 :
                            _Warnings = ((com.google.checkout.schema._2.impl.DiagnoseResponseImpl.WarningsTypeImpl) spawnChildFromText((com.google.checkout.schema._2.impl.DiagnoseResponseImpl.WarningsTypeImpl.class), 5, value));
                            return ;
                    }
    ...
    public static class WarningsTypeImpl implements com.google.checkout.schema._2.DiagnoseResponse.WarningsType, com.sun.xml.bind.JAXBObject, com.google.checkout.schema._2.impl.runtime.UnmarshallableObject, com.google.checkout.schema._2.impl.runtime.XMLSerializable, com.google.checkout.schema._2.impl.runtime.ValidatableObject
    {
        ...
        private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
            return (com.google.checkout.schema._2.DiagnoseResponse.WarningsType.class);
        }
        ...
        public com.google.checkout.schema._2.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.google.checkout.schema._2.impl.runtime.UnmarshallingContext context) {
            return new com.google.checkout.schema._2.impl.DiagnoseResponseImpl.WarningsTypeImpl.Unmarshaller(context);
        }
...
+"\u0000~\u0000\u0010q\u0000~\u0000\u0005q\u0000~\u0000%x"));
            ...
            extends com.google.checkout.schema._2.impl.runtime.AbstractUnmarshallingEventHandlerImpl
        {
            ...
            public java.lang.Object owner() {
                return com.google.checkout.schema._2.impl.DiagnoseResponseImpl.WarningsTypeImpl.this;
            }
