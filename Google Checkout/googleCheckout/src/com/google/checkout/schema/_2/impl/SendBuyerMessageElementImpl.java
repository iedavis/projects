    ...
    implements com.google.checkout.schema._2.SendBuyerMessageElement, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.google.checkout.schema._2.impl.runtime.UnmarshallableObject, com.google.checkout.schema._2.impl.runtime.XMLSerializable, com.google.checkout.schema._2.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.google.checkout.schema._2.SendBuyerMessageElement.class);
    }
    ...
    public com.google.checkout.schema._2.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.google.checkout.schema._2.impl.runtime.UnmarshallingContext context) {
        return new com.google.checkout.schema._2.impl.SendBuyerMessageElementImpl.Unmarshaller(context);
    }

    public void serializeBody(com.google.checkout.schema._2.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://checkout.google.com/schema/2", "send-buyer-message");
...
+"sq\u0000~\u00000t\u0000\u0007messaget\u0000#http://checkout.google.com/schema/2sq\u0000~\u0000#"
+"ppsq\u0000~\u0000\u0000q\u0000~\u0000(p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u000fppsr\u0000$com.sun.msv.datatype.xsd."
+"BooleanType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0014q\u0000~\u0000\u001at\u0000\u0007booleanq\u0000~\u0000.q\u0000~\u0000 sq\u0000~\u0000!q"
+"\u0000~\u0000Aq\u0000~\u0000\u001asq\u0000~\u0000#ppsq\u0000~\u0000%q\u0000~\u0000(pq\u0000~\u0000)q\u0000~\u00002q\u0000~\u00006sq\u0000~\u00000t\u0000\nsend-em"
+"ailq\u0000~\u0000:q\u0000~\u00006sq\u0000~\u0000%ppsq\u0000~\u0000\u000fppsr\u0000\"com.sun.msv.datatype.xsd.To"
+"kenType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0013q\u0000~\u0000\u001at\u0000\u0005tokenq\u0000~\u0000.\u0001q\u0000~\u0000 sq\u0000~\u0000!q\u0000~\u0000Kq"
+"\u0000~\u0000\u001asq\u0000~\u00000t\u0000\u0013google-order-numbert\u0000\u0000sq\u0000~\u0000#ppsq\u0000~\u0000%q\u0000~\u0000(pq\u0000~\u0000)"
+"q\u0000~\u00002q\u0000~\u00006sq\u0000~\u00000t\u0000\u0012send-buyer-messageq\u0000~\u0000:sr\u0000\"com.sun.msv.gr"
...
+"\u0000~\u0000;q\u0000~\u0000\fq\u0000~\u0000$q\u0000~\u0000Cq\u0000~\u0000Pq\u0000~\u0000\nq\u0000~\u0000=q\u0000~\u0000\tx"));
        ...
        extends com.google.checkout.schema._2.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.google.checkout.schema._2.impl.SendBuyerMessageElementImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("send-buyer-message" == ___local)&&("http://checkout.google.com/schema/2" == ___uri)) {
                ...
                switch (state) {
                    case  1 :
                        if (("google-order-number" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((com.google.checkout.schema._2.impl.SendBuyerMessageRequestImpl)com.google.checkout.schema._2.impl.SendBuyerMessageElementImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
                        break;
                    case  3 :
